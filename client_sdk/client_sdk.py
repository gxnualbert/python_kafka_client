...
if system == "Linux":
    sdk_lib = ctypes.cdll.LoadLibrary("/root/RF/fsp_sss_stream_autotest/libclient_sdk_c.so")
elif system == "Windows":
...
class client_sdk(object):
	...
	def subscribe_audio_callback(self, stream_id, subscribe_token):
		def on_subscribe_audio(data, data_len, from_id, from_param):
			print "aaaaaaaAAAAAAAAAA",data_len,from_id,from_param
...
if __name__=='__main__':
    ...
    b = a.login(x,"1;xxx")
    print b
#    lscommand =' curl -H "Content-Type:application/json;charset=UTF-8" --http2 -s -k --data \'{"sequence":1,"requestType":1,"appID":"app123","verificationCode":"vc123"}\' https:/192.168.7.165:8444/api/v1.0/login'
#    (status,output) = commands.getstatusoutput(lscommand)
#    print output
#    c = json.loads(output)
#    d = c["appToken"]
#    print d
#    cscommand = ' curl -H "Content-Type:application/json;charset=UTF-8" --http2 -s -k --data \'{"sequence":1,"requestType":1,"streamType":1,"streamProperty":1,"appToken":"%s"}\' https:/192.168.7.165:8444/api/v1.0/create_stream'%d
#    print cscommand
...
#    print g,h,i
#    a.login("192.168.7.75:54321","1;cyn")
#    j = a.publish_audio(g,h)
#    print j
#    filepath = "/usr/lib/python2.7/site-packages/client_sdk/audio.dat"
#    a.play_audio(filepath,j)
#    time.sleep(5)
#    aa =client_sdk()
#    aa.init()
#    aa.login("192.168.7.75:54321","1;ling")
